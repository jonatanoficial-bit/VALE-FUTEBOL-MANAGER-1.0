...
const CACHE_NAME = "vfm-cache-v1.54.0_hub_clean_gameplay_focus";
const CORE_ASSETS = [
  './',
  './index.html?v=v1.54.0_hub_clean_gameplay_focus',
  './styles.css?v=v1.54.0_hub_clean_gameplay_focus',
  './app.js?v=v1.54.0_hub_clean_gameplay_focus',
  './manifest.json',
  './favicon.ico',

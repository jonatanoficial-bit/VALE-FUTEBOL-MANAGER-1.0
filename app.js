/* VFM PATCH v1.10.8+guard (prevents double-load redeclare errors on GitHub Pages) */
if (window.__VFM_APP_LOADED__) {
  console.warn("[VFM] app.js carregado novamente; ignorando para evitar redeclarações.");
} else {
  window.__VFM_APP_LOADED__ = true;
  (function(){
(() => {
  "use strict";
